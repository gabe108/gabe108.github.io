var Glitcher = (function () {
    ...
    Glitcher.prototype.renderImage = function (img) {
        this.canvas.width = this.origCanvas.width = this.width = img.width + 20;
        this.canvas.height = this.origCanvas.height = this.height = img.height + 220;
...
glitcher.glitch('https://i.imgur.com/qORIJ6x.png', function () {
    document.getElementById("Hello").appendChild(glitcher.canvas);
});
